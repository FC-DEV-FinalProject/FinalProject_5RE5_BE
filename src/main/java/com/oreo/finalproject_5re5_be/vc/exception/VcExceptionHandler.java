...
public class VcExceptionHandler {
    ...
    public ResponseEntity<ResponseDto<String>> handleVcNotFoundProjectException(VcNotFoundProjectException e, HttpServletRequest request) {
    ...
    public ResponseEntity<ResponseDto<String>> handleVcNotFoundSrcException(VcNotFoundSrcException e, HttpServletRequest request) {
    ...
    public ResponseEntity<ResponseDto<String>> handleVcNotFoundTrgException(VcNotFoundTrgException e, HttpServletRequest request) {
    ...
    public ResponseEntity<ResponseDto<String>> handleVcNotFoundResultException(VcNotFoundResultException e, HttpServletRequest request) {
    ...
    public ResponseEntity<ResponseDto<String>> handleVcNotFoundTextException(VcNotFoundTextException e, HttpServletRequest request) {
    ...
    public ResponseEntity<ResponseDto<String>> handleVcNotMemberException(VcNotMemberException e, HttpServletRequest request) {
    ...
    public ResponseEntity<ResponseDto<String>> handleRuntimeException(RuntimeException e, HttpServletRequest request) {
    ...
    public ResponseEntity<ResponseDto<String>> handleException(Exception e, HttpServletRequest request) {
        log.error("VC RestController 내 handlerException 호출, {}, {}", request.getRequestURI(), e.getMessage());
