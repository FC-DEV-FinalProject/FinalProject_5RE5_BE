...
public interface AudioFileRepository extends JpaRepository<AudioFile, Long> {
    ...
    ConcatRow findConcatRowByAudioFile(@Param("audioFileId") Long audioFileSeq);
    ...
    Optional<AudioFile> findByRowSeq(@Param("concatRowSeq") Long concatRowSeq);

    @Query("SELECT af FROM audio_file af WHERE FUNCTION('DATE', af.createdDate) = :date")
    List<AudioFile> findByCreatedDateOnly(@Param("date") LocalDate date);
