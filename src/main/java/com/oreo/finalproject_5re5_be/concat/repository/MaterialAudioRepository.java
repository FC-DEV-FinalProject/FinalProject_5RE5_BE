...
public interface MaterialAudioRepository extends JpaRepository<MaterialAudio, Long> {
    ...
    List<AudioFile> findAudioFilesByConcatResult(@Param("resultSeq") Long resultSeq);

    @Query("SELECT ma.concatResult FROM material_audio ma WHERE ma.audioFile.audioFileSeq = :audioFileSeq")
    List<ConcatResult> findConcatResultsByAudioFileSeq(@Param("audioFileSeq") Long audioFileSeq);
    ...
    void deleteByConcatResultSeq(@Param("concatResultSeq") Long concatResultSeq);
